...
const resetPassword = async (resetPasswordToken, newPassword) => {
  try {
    ...
    throw new ApiError(httpStatus.UNAUTHORIZED, 'Token de redefinição de senha inválido');
  }
};
...
const verifyEmail = async (verifyEmailToken) => {
  try {
    ...
    throw new ApiError(httpStatus.UNAUTHORIZED, 'Token de verificação de email inválido');
  }
};
